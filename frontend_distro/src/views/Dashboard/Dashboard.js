...
import { GetDashboardDataMaster, GetDashboardProduct } from './ZActionDashboard'
...
class Dashboard extends Component {
  ...
  render() {
    let { user } = this.props.AllDashboardReducer.DashboardDatamaster
    let { barang } = this.props.AllDashboardReducer.DashboardProduct
    ...
    return (
      <div className="animated fadeIn">
        <Row>
          ...
          <Col xs="12" sm="6" lg="6">
            <Link to="/productManagement/ListProduct">
              <Widget02 header={barang} mainText="Type Product" icon="fa fa-bookmark-o" color="primary" footer />
            </Link>
          </Col>
        </Row>
      </div>
...
const mapDispatchToProps = { GetDashboardDataMaster, GetDashboardProduct }
